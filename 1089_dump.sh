...
set -x
python3 -u "$DIR"/tcpproxy.py -s5 -li 0.0.0.0 -lp "$PORT" -ac "$CA_PEM" -ak "$CA_KEY_PEM" -s -v -im "hexdump:wsdirection=1:logdir=\"$LOG_DIR_1089\"" -om "hexdump:wsdirection=1:logdir=\"$LOG_DIR_1089\""
